...
% function taken from the toolbox Optimization-on-manifolds-with-extra-constraints-master
% by Liu and Boumal, available at https://github.com/losangle.
% It should be added in Manopt toolbox some day
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
